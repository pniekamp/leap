...
//|///////////////////// send_http_request ////////////////////////////////
static bool send_http_request(StreamSocket &socket, HTTPRequest const &msg)
{
...
//|///////////////////// send_http_response ///////////////////////////////
static bool send_http_response(StreamSocket &socket, HTTPResponse const &msg)
{
  string head = msg.head();
...
//|///////////////////// read_http_base ///////////////////////////////////
static bool read_http_base(read_http_state &state, StreamSocket &socket, HTTPBase *msg)
{ 
  char line[4096];
...
//|///////////////////// read_http_request ////////////////////////////////
static bool read_http_request(StreamSocket &socket, HTTPRequest *msg, int timeout = 20000)
{
  msg->clear();
...
//|///////////////////// read_http_response ///////////////////////////////
static bool read_http_response(StreamSocket &socket, HTTPResponse *msg, int timeout = 20000)
{
  msg->clear();
...
//|///////////////////// read_http_response ///////////////////////////////
static bool read_http_response(read_http_state &state, StreamSocket &socket, HTTPResponse *msg)
{
  char line[4096];
...
static bool send_websocket_frame(StreamSocket &socket, const void *buffer, int bytes, int opcode, bool fin, bool masked, uint32_t maskkey = 0)
{
  int len = 0;
  uint8_t frame[16];
...
static bool send_websocket_message(StreamSocket &socket, const void *buffer, int bytes, int opcode, bool masked, uint32_t maskkey = 0)
{
...
static tuple<int, int, int> read_websocket_frame(StreamSocket &socket, WebSocketMessage *msg, int timeout)
{
  uint8_t head[2];
...
static bool read_websocket_message(StreamSocket &socket, WebSocketMessage *msg, int timeout = 20000)
{
  if (!socket.connected())
